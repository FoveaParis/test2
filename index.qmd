...
👉 [ghcr.io/FoveaParis/test2](https://ghcr.io/FoveaParis/test2) 🐳
...
#| eval: false
docker run -it ghcr.io/FoveaParis/test2:devel R
```
...
docker run \
    ...
    -e PASSWORD=OHCA \
    -p 8787:8787 \
    ghcr.io/FoveaParis/test2:devel
```
...
#| eval: false
git clone git@github.com:FoveaParis/test2.git && cd FoveaParis/test2
